package com.enterprise.alin.calculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    //Variable to hold the opperands and type of calculations
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonDivide = (Button) findViewById(R.id.buttonDevide);
...
//                Double number = Double.parseDouble(newNumber.getText().toString());
